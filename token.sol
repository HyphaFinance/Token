...
contract HyphaFinance is Context, IERC20Metadata, Ownable, ReentrancyGuard  {
  ...
  uint256 private _hyphaSupply = 100_000_000_000 * 10 ** 18;
...
library SafeMath {
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "HYPHA: safeMath error");

    return c;
  }

  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    require(b > 0, "HYPHA: safeMath error"); // Solidity only automatically asserts when dividing by 0
    uint256 c = a / b;
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    require(b <= a, "HYPHA: safeMath error");
    uint256 c = a - b;
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "HYPHA: safeMath error");

    return c;
  }

  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    require(b != 0, "HYPHA: safeMath error");
    return a % b;
  }
}
